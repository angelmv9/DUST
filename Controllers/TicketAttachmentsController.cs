...
namespace DUST.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,UserId,Created,FileDescription,FileName,FileExtension,ByteArrayData")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,UserId,Created,FileDescription,FileName,FileExtension,ByteArrayData")] TicketAttachment ticketAttachment)
        {
